...
permettant d’explorer différents aspects de l’algorithmique au travers d’exercices interactifs et graphiques.\\
Ma principale tâche a été d'effectuer le portage de l'existant, un client lourd Java, en une application web.\\
Ce changement important a entraîné l'apparition de plusieurs problématiques auxquelles il a fallu apporter des solutions :
\begin{tightemize}
...
\begin{tabular}{cl}
2017            & Chargé de TP. Préparation et animation de l'atelier du TP noté.
\end{tabular}
\sectionsep

\runsubsection{Préparation de l'informatique}\\
...
\runsubsection{Démo de MUTE} %MUTE, a Peer-to-Peer Real-Time Web Collaborative Editor
\descript{| HCERES}
\location{13 décembre 2016}
\sectionsep

\runsubsection{Démo de MUTE}
\descript{| Rencontres Inria Industrie "Nouvelles technologies pour la protection des données et des systèmes numériques"  }
\location{8 décembre 2016}
\sectionsep

\runsubsection{Démo de MUTE}
\descript{| Délégation de Recteurs des universités de technologie du Mexique }
\location{01 décembre 2016}
\sectionsep

\runsubsection{Démo de MUTE}
\descript{| Rencontres Inria Industrie "Interaction avec les objets et services numériques"  }
\location{25 novembre 2016}
\sectionsep

\runsubsection{Démo de MUTE}
\descript{| Évaluation INRIA }
\location{14 octobre 2016}
\sectionsep

\runsubsection{Présentation de PLM}
\descript{| Séminaire Ingénieurs Jeunes Diplômés}
\location{02 février 2016}
\sectionsep

\runsubsection{Présentation de PLM}
\descript{| Séminaire Ingénieurs Jeunes Diplômés}
\location{03 mars 2015}
\sectionsep
