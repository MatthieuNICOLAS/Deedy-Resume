...
Afin d'être validés, ces travaux ont été intégrés dans \href{https://www.coedit.re}{\customboldlink{MUTE}},
...
\href{http://people.irisa.fr/Martin.Quinson/Teaching/PLM/}{\customboldlink{La PLM}}
...
\descript{Portage d’un exerciseur de programmation sur une architecture web}
\location{Stage | Avril 2015 - Juin 2015}
Co-encadrant d'un étudiant de 2A - DUT Informatique
\sectionsep

\descript{Integration d’un langage visuel de programmation dans exerciseur de programmation}
\location{Stage | Avril 2015 - Juin 2015}
Co-encadrant d'un étudiant de 2A - DUT Informatique
\sectionsep

\descript{Conception et realisation d’un editeur d’exercices pour un exerciseur de programmation}
\location{Stage | Avril 2015 - Juin 2015}
Co-encadrant d'un étudiant de 2A - DUT Informatique
\sectionsep
